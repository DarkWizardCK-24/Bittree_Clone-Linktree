...
const Navbar = () => {
    ...
    return (<>{showNavbar && <nav className='bg-white flex justify-between right-[10vw] w-[80vw] absolute top-10 rounded-full p-3'>
        <div className="logo flex gap-16 items-center">
            <Link href={"/"}>
                <svg className='h-8 px-4' viewBox="0 0 1176 238" title="Linktree Logo" xmlns="http://www.w3.org/2000/svg">
            ...
            <ul className='flex gap-2'>
                <Link className={`${poppins2.className} rounded-lg text-xl cursor-pointer hover:bg-gray-100 p-4 transition-all duration-3000 $`} href={"/"}>Templates</Link>
                <Link className={`${poppins2.className} rounded-lg text-xl cursor-pointer hover:bg-gray-100 p-4 transition-all duration-3000 $`} href={"/"}>Marketplace</Link>
                <Link className={`${poppins2.className} rounded-lg text-xl cursor-pointer hover:bg-gray-100 p-4 transition-all duration-3000 $`} href={"/"}>Discover</Link>
                <Link className={`${poppins2.className} rounded-lg text-xl cursor-pointer hover:bg-gray-100 p-4 transition-all duration-3000 $`} href={"/"}>Pricing</Link>
                <Link className={`${poppins2.className} rounded-lg text-xl cursor-pointer hover:bg-gray-100 p-4 transition-all duration-3000 $`} href={"/"}>Learn</Link>
            </ul>
        </div>
        <div className='flex gap-3'>
            <button className={`${poppins2.className} login text-xl font-medium bg-gray-100 hover:bg-gray-200 p-4 px-5 rounded-lg`}>Login</button>
            <button className={`${poppins2.className} signup text-xl font-medium bg-gray-900 hover:bg-gray-700 text-white p-4 px-6 rounded-full`}>Sign up Free</button>
        </div>
    </nav>
    }
    </>
